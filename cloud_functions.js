Moralis.Cloud.define("getUserItems", async (request) => {
    ...
    for (let i = 0; i < queryResults.length; ++i) {
      ...
      query.equalTo("tokenId", queryResults[i].attributes.token_id);  
      query.select("askingPrice","tokenId");
      ...
      let obj = {
        ...
        "askingPrice":queryResult ? queryResult.attributes.askingPrice : undefined,
      };
      results.push(obj);
    }
    return results;
